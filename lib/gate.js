function Gate(options, canvas){
  ...
  this.gateStart = options.gateStart || Math.floor((Math.random() * canvas.width-200) + 0)
  this.gateEnd = options.gateEnd || (this.gateStart + Math.floor((Math.random() * 200) + 10) + 10);
}
