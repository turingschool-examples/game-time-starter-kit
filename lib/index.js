...
car2.push(new Car({x: 300, y: 400, width: 65}));
car2.push(new Car({x: 100, y: 400, width: 65}));
car2.push(new Car({x: -100, y: 400, width: 65}));

car3.push(new Car({x: 150, y: 450, width: 65}));
car3.push(new Car({x: -5, y: 450, width: 65}));
car3.push(new Car({x: -250, y: 450, width: 65}));

car4.push(new Car({x: 400, y: 500, width: 65}));
car4.push(new Car({x: 200, y: 500, width: 65}));
car4.push(new Car({x: 50, y: 500, width: 65}));
car4.push(new Car({x: -150, y: 500, width: 65}));


log1.push(new Log({x: 500, y: 200}));
log1.push(new Log({x: 100, y: 200}));
// log1.push(new Log({x: -250, y: 250}));
log2.push(new Log({x: 400, y: 100}));
...
turtle2.push(new Turtle({x: 100, y: 50}));
turtle2.push(new Turtle({x: 25, y: 50}));
...
function collision(car) {
  if (frog.x < car.x + car.width && frog.x + frog.width > car.x && frog.y < car.y + car.height && frog.y + frog.height > car.y) {
    loseGame();
  }
}
...
function rideLog(log) {
  if (frog.x < log.x + log.width && frog.x + frog.width > log.x && frog.y < log.y + log.height && frog.y + frog.height > log.y) {
    frog.x++;
    isDrowning = false;
  }
}
...
function rideTurtle(turtle) {
  if (frog.x < turtle.x + turtle.width && frog.x + frog.width > turtle.x && frog.y < turtle.y + turtle.height && frog.y + frog.height > turtle.y) {
    frog.x--;
    isDrowning = false;
  }
}
...
function getHome(lilypad) {
  if (frog.x < lilypad.x + lilypad.width && frog.x + frog.width > lilypad.x && frog.y < lilypad.y + lilypad.height && frog.y + frog.height > lilypad.y) {
    isDrowning = false;
