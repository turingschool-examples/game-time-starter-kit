...
var surfer = new Surfer({canvas: canvas});
var rocks = createRocks();
var world = new World(canvas.width, canvas.height, surfer, rocks);
var collision = new Collision(rocks, surfer);
