...
requestAnimationFrame(function gameLoop() {
  ...
  log2.forEach(function (log) {log.logDraw(context).logMove()});
  turtle1.forEach(function(turtle) {turtle.turtleDraw(context).turtleMove()});
  turtle2.forEach(function(turtle) {turtle.turtleDraw(context).turtleMove()});
