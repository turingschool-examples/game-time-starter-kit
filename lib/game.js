...
Game.prototype.grow = function () {
  ...
  // console.log("WILL ADD NEW SNAKE TAIL AT ", current.prevX, " ", current.prevY);
  current.nextSnake = new Snake ({x: current.prevX, y: current.prevY, time: new Date(), nextSnake: null, direction: current.direction}, this.context);
};
